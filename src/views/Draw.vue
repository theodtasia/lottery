<template>
  <div>
    <nav class="bg-black shadow">
      <div
        class="container flex items-center justify-center px-6 py-8 mx-auto text-gray-100 capitalize"
      >
        <ul class="navbar-nav">
          <router-link
            class="border-b-2 border-transparent hover:text-pink-800 hover:border-pink-800 mx-1.5 sm:mx-6"
            to=""
          >
            Home
          </router-link>
          ...
          >
            <font-awesome-icon :icon="['fas', 'user-alt']" class="mx-2 fa-lg icon alt" />
            Logout</router-link
          >
        </ul>
      </div>
    ...
    <div class="grid grid-cols-2 gap-3 bg-gray-800">
      ...
      <div class="bg-gray-400">
        <h2 id="title" class="text-2xl font-semibold leading-normal mt-4 mb-2 text-pink-800">
          Your Bet
        </h2>
        <div class="flex justify-center flex-row m-10 gap-4  md:grid-rows">
        ...
        <h2 class="flex justify-end text-2xl font-semibold leading-normal m-4 p-4 text-pink-800">
