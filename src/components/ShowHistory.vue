<template>
  <div class="grid grid-cols-1 gap2 justify-items-center text-center overflow-hidden">
    <div
      class=" border-4 p-1 m-auto text-align-center rounded w-80 border-gray-400 text-center mb-5"
    >
      ...
      <button
        class="bg-red-500  text-gray-100 rounded font-bold m-2  hover:bg-red-400 px-2 py-1 focus:outline-none inline-flex align-middle text-md"
    ...
    return {
      content: [
        ...
        { title: 'Total Amount: ', item: this.game.amount },
        {
          ...
          item: this.game.winningNumbers.length === 0 ? '-' : this.game.winningNumbers,
        },
